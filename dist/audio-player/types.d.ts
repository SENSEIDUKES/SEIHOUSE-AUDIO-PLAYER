...
import { CueManifest } from './cues/cueTypes';
/**
...
export type PlayerEventType = 'track-change' | 'play' | 'pause' | 'queue-end' | 'error' | 'fallback-source';
...
export interface SessionEngine extends AudioPlayerEngine {
    ...
    subscribe: <T extends PlayerEventType>(eventType: T, handler: (payload: PlayerEventPayload[T]) => void) => () => void;
